...
public class HookLoader implements IXposedHookLoadPackage, IXposedHookZygoteInit {
     ...
     * 实际hook逻辑处理类
     */
    private final String handleHookClass = org.quanye.xposed_module_template.HackEntry.class.getName();
    /**
     * 实际hook逻辑处理类的入口方法
     */
    ...
    private File findApkFile(Context context, String modulePackageName) {
        ...
        try {
            Context moduleContext = context.createPackageContext(modulePackageName, Context.CONTEXT_INCLUDE_CODE | Context.CONTEXT_IGNORE_SECURITY);
